...
class OrderFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        // 随机生成发货状态
        $ship = $this->faker->randoElement(array_keys(Order::$shipStatusMap));
        // 优惠券
        $coupon = null;
        // 30% 概率该订单使用了优惠券
        if (random_int(0, 10) < 3) {
            // 为了避免出现逻辑错误，我们只选择没有最低金额限制的优惠券
            $coupon = CouponCode::query()->where('min_amount', 0)->inRandommOrder()->first();
        ...
        return [
            ...
            'paid_at'       =>  $this->faker->dateTimeBetween('-30 days'), // 30 天钱到现在任意时间点
