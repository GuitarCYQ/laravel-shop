...
<div class="card">
  ...
  <div class="card-body">
    ...
    <user-addresses-create-and-edit inline-template>
      ...
      {{ csrf_field() }}
      <!-- 注意这里多了 @change -->
        <select-district :init-value="{{ json_encode([old('privince', $address->province), old('city', $address->city), old('district', $address->district)]) }}" @change="onDistrictChanged" inline-template>
